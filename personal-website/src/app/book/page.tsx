  ...
  return (
    <div className="bg-forest-green min-h-screen">
      <div className="container mx-auto px-12 py-16">
        <h1 className="text-6xl font-bold text-neutral-cream mb-12">Comfort and Chaos</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-4xl font-bold text-neutral-cream mb-6">About the Book</h2>
            <p className="text-lg text-neutral-cream mb-8">
